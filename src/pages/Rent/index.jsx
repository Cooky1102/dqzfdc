...
class Rent extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={[style.rent_container] + " rent_container"}>
                <Row type="flex" align="bottom" className={style.search_container}>
                    ...
                    <Col span={14} offset={4}>
                        <Breadcrumb separator=">">
                            ...
                            <Breadcrumb.Item>租房</Breadcrumb.Item>
                        </Breadcrumb>
                    </Col>
                </Row>
                <Row>
                    <Col span={14} offset={4} >
                        <List
                            ...
                            renderItem={item => (
                                <Link to={"/detail/" + JSON.stringify({ type: "rent", id: item.get("Id") })} className={style.listItem}>
                                    <List.Item
                                        key={item.get('Id')}
                                        extra={
                                            <img
...
const mapStateToProps = (state) => {
    return {
        houseList: state.getIn(['rent', 'houseList']),
        total_count: state.getIn(['rent', 'total_count']),
